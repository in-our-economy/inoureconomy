...
The charts below show how the affordability of ticket prices has changed from 1994 to 2026. There are some assumptions 
...
* 81% of U.S. households couldn't afford to send a single member to all the USMNT group games and
* 90% of American households couldn't afford to send a single member to follow a team through the whole World Cup even if they liquidated their all their checking accounts.
